...
public class FaceHelper {
    ...
    // 你的 API key https://blog.csdn.net/qq_23412263/article/details/86232682?spm=1001.2014.3001.5506
    public static final String API_KEY = "grFXafyJKKfW0rZzKMG9i-ZOqwkar90S";
    // 你的 API  SECRET https://console.faceplusplus.com.cn/app/apikey/list
    private static final String API_SECRET = "X6gQ6y3IyvmxIZSbJquVOfqCC7LNwLjU";
    ...
    /**
     * 张张嘴或眨眨眼检测
     * @param imgBase64    //https://blog.csdn.net/qq_34823218/article/details/114931827
     * @param checkType
     * @param userId
